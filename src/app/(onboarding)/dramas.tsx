...
// Bundled cinematic key-art replaces placeholder stock photos
const POSTERS = {
  cloy: require('@/assets/images/posters/cloy.jpg'),
  goblin: require('@/assets/images/posters/goblin.jpg'),
  squidGame: require('@/assets/images/posters/squid-game.jpg'),
  theGlory: require('@/assets/images/posters/the-glory.jpg'),
  businessProposal: require('@/assets/images/posters/business-proposal.jpg'),
  attorneyWoo: require('@/assets/images/posters/attorney-woo.jpg'),
};

type SeedDrama = Omit<Drama, 'poster_url'> & {
  poster_url?: Drama['poster_url'] | ImageSourcePropType;
};
...
export default function OnboardingDramasScreen() {
  const [dramas, setDramas] = useState<SeedDrama[]>([]);
...
const SEED_DRAMAS: Drama[] = [
  ...
  },
  {
    ...
    original_title: '사내맞선',
    poster_url: POSTERS.businessProposal,
    year: 2022,
  ...
  },
  {
    ...
    poster_url: POSTERS.attorneyWoo,
    year: 2022,
    genres: ['Legal', 'Drama'],
    synopsis: null,
    cast_text: null,
