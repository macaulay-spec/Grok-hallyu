...
export default function EditProfileScreen() {
  const { user, profile, refreshProfile, startDemoSession } = useAuth();
  ...
  const handleSave = async () => {
    ...
    if (DEMO_MODE) {
      // Offline demo: update the local profile, no storage uploads.
      setLoading(true);
      await startDemoSession({
        display_name: displayName.trim() || profile?.display_name || 'Demo Fan',
        bio: bio.trim() || null,
